...
public class SwipeAction {
    ...
    public SwipeAction(Dir swipeDir, String actionText, Context context) {
    ...
    private void init() {
        ...
        if (swipeDir == Dir.LEFT) {
            ...
            backgroundPaint.setColor(ContextCompat.getColor(context, R.color.green));
        } else if (swipeDir == Dir.RIGHT) {
            textPaint.setTextAlign(Paint.Align.RIGHT);
            backgroundPaint.setColor(ContextCompat.getColor(context, R.color.red));
        }
    }
